#!/usr/bin/env python3
"""
CropHealth Detection - YOLOv8n / YOLOv11n Training
Utilise Ultralytics pour YOLOv8n et YOLOv11n

Usage:
    python yolo_trainer.py --model yolov8n --data data/yolo_crop/data.yaml --device 0
    python yolo_trainer.py --model yolov11n --data data/yolo_crop/data.yaml --device 0
"""
import argparse
import sys
...
def train_yolo(args):
    """Entraînement YOLOv8n ou YOLOv11n"""
